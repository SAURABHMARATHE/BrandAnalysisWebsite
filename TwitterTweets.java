...
public class TwitterTweets 
{
	public static void main(String[] args) throws TwitterException {
		...
		cb.setDebugEnabled(true).setOAuthConsumerKey(“dfjajlfajlfjaslfjaslfjalfkajfjal”) // Change the Key value, Token etc. with your actual token value
.setOAuthConsumerSecret(“afasfafafjasfijasfjaspfaskpfoaskfpasofkpasf”)
.setOAuthAccessToken(“sadasfasfaasfasfafaff”)
.setOAuthAccessTokenSecret(“fasfasffasfafasfasfasfsafasfafsaa”);
...
System.out.println(“@” + status.getUser().getScreenName() + ” _____ ” + status.getText()
+ ” _____ ” + status.getCreatedAt() + ” _____ ” + status.getLang() + ” _____ ” +
status.getUser().getLocation() + ” _____ ” + status.getPlace() + “\n”);
}
...
// TODO Auto-generated method stub
		...
		String keywords[] = {"modi", "namo", "obama", "kejriwal"};
...
public class TwitterTweets {
	...
	public static File tweet(String fileName, String searchPost) throws IOException
	{
